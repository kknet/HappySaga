...
namespace com.zonglv.minigame.common {
    ...
    public class CUtils {
        public const string ActionInterstitial = "show_interstitial_ads";
        public const string ActionBanner = "show_banner_ads";
	...
	private static AndroidJavaObject obj_Activity;
        ...
        internal static bool IsInterstitialReady() {
            return AdController.instance.IsInterstitialLoaded;
        }
        ...
        AdController.instance.LoadInterstitial ();
#endif
        }
        public static void ShowInterstitialAd() {
            ...
            if (IsActionAvailable (ActionInterstitial, ConfigController.Config.intertitialPeriod)) {
#if UNITY_ANDROID || UNITY_IPHONE
            ...
            AdController.instance.ShowInterstitial ();
                ...
                if (JobWorker.instance.onShowInterstitial != null) {
                    ...
                    SetActionTime ("show_interstitial_ads");
                }
#endif
            } else {
                MonoBehaviour.print ("time can't display interstitial ");
            }
        }
        ...
        public static void ShowBannerAd() {
            if (IsBuyItem ()) return;
            if (IsAdsRemoved ()) return;
            if (IsActionAvailable (ActionBanner, ConfigController.Config.bannerPeriod)) {
#if UNITY_ANDROID || UNITY_IPHONE

            AdController.instance.ShowBanner ();
            SetActionTime (ActionBanner);
#else
