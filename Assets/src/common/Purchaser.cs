...
namespace com.zonglv.minigame.common {
    ...
    public class IAPItem {
        ...
        public string receipt;  //https://docs.unity3d.com/Manual/UnityIAPPurchaseReceipts.html
        public string signature;//https://docs.unity3d.com/Manual/UnityIAPPurchaseReceipts.html
        ...
        public override bool Equals(object obj) {
            if (obj is IAPItem) {
                return this.productID.Equals (((IAPItem)obj).productID);
            }
            return base.Equals (obj);
        }

        public override int GetHashCode() {
            return 1542337929 + EqualityComparer<string>.Default.GetHashCode (productID);
        }
    }
