...
namespace com.zonglv.minigame.game.bow
{
    ...
    /// 移动场景的类
    /// </summary>
    public class CameraMoveSprite : MonoBehaviour
    {
        ...
        void Update()
        {
            if (SlingShot.slingshotState == SlingshotState.Idle && GameManagerSprite.CurrentGameState == GameState.Playing)
            {
                //drag start
        ...
        public SlingShotSprite SlingShot;
    }
}
